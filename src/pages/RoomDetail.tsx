...
const RoomDetail = () => {
    ...
    const handleBooking = async () => {
        ...
        if (soLuongKhach > room.khach) {
            alert(`Phòng này chỉ tối đa ${room.khach} khách`);
            return;
        }
    ...
    return (
        <div className="container py-3 py-md-4">
            ...
            <div className="row g-4">
                ...
                <h2 className="room-detail-title fw-bold">
                    {room.tenPhong}
                </h2>
                ...
                <img
                    ...
                    alt={data.tenPhong}
                    className="img-fluid rounded-4 mb-3 mb-md-4 room-detail-image"
                    style={{
                        width: "100%",
                        height: "400px",
                        objectFit: "cover"
                ...
                <div className="col-12 col-lg-8">
                    ...
                    <p className="text-muted room-info">
                    ...
                    <div className="mb-3">
                        <p className="service-item">🏠 Toàn bộ nhà</p>
                        <p className="service-item">🧹 Vệ sinh tăng cường</p>
                        <p className="service-item">🔑 Nhận phòng dễ dàng</p>
                        <p className="service-item">❌ Miễn phí huỷ trong 48 giờ</p>
                    </div>
                    ...
                    <div className="card p-3 mb-4">
                        ...
                        <div className="d-flex justify-content-between align-items-center comment-action">
                            ...
                            <button
                                className="btn btn-danger comment-submit-btn"
                    ...
                    <div className="d-flex justify-content-center">
                        ...
                        <ul className="pagination">
                            ...
                            <li
                                className={`page-item ${commentPage === 1
                                    ? "disabled"
                                    : ""
                                    }`}
                            >
                            ...
                            {getPages().map((p, i) => (
                                <li
                                    key={i}
                                    className={`page-item ${commentPage === p
                                        ? "active"
                                        : ""
                                        } ${p === "..."
                                            ? "disabled"
                            ...
                            <li
                                className={`page-item ${commentPage === totalPage
                                    ? "disabled"
                                    : ""
                                    }`}
                            >
                ...
                <div className="col-12 col-md-8 col-lg-4 mx-auto">
                    ...
                    <div className="booking-card card shadow border-0 p-3 p-md-4">
                        ...
                        <div className="border rounded mb-3">
                            ...
                            <div className="row g-0 booking-date-group">

                                <div className="col-12 col-md-6 border-end p-2 booking-date-item">
                                ...
                                <div className="col-12 col-md-6 p-2 booking-date-item">
